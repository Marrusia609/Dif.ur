...
/************************************************              Дано             *************************************************/
    ...
    int t0global = 0;    // начальное время
    int t1global = 720 -5;  // конечное время
...
//            K[0] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*Xt)*gt)/(Kvect.at(29)+gt)+Kvect.at(24)*gp-Kvect.at(25)*gt);
//            K[1] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(Xt + hi[6]/5.0))*(gt + hi[6]*K[0]/5.0))/(Kvect.at(29)+(gt + hi[6]*K[0]/5.0))+Kvect.at(24)*(gp + hi[6]/5.0)-Kvect.at(25)*(gt + hi[6]*K[0]/5.0));
//            K[2] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(Xt + 3*hi[6]/10.0))*(gt + 3*hi[6]*K[0]/40.0 + 9*hi[6]*K[1]/40.0))/(Kvect.at(29)+(gt + 3*hi[6]*K[0]/40.0 + 9*hi[6]*K[1]/40.0))+Kvect.at(24)*(gp + 3*hi[6]/10.0)-Kvect.at(25)*(gt + 3*hi[6]*K[0]/40.0 + 9*hi[6]*K[1]/40.0));
//            K[3] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(Xt + 4*hi[6]/5.0))*(gt + 44*hi[6]*K[0]/45.0 + (-56*hi[6]*K[1]/15.0) + 32*hi[6]*K[2]/9.0))/(Kvect.at(29)+(gt + 44*hi[6]*K[0]/45.0 + (-56*hi[6]*K[1]/15.0) + 32*hi[6]*K[2]/9.0))+Kvect.at(24)*(gp + 4*hi[6]/5.0)-Kvect.at(25)*(gt + 44*hi[6]*K[0]/45.0 + (-56*hi[6]*K[1]/15.0) + 32*hi[6]*K[2]/9.0));
//            K[4] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(Xt + 8*hi[6]/9.0))*(gt + 19372*hi[6]*K[0]/6561.0 + (-25360*hi[6]*K[1]/2187.0) + 64448*hi[6]*K[2]/6561.0 + (-212*hi[6]*K[3]/729.0) ))/(Kvect.at(29)+(gt + 19372*hi[6]*K[0]/6561.0 + (-25360*hi[6]*K[1]/2187.0) + 64448*hi[6]*K[2]/6561.0 + (-212*hi[6]*K[3]/729.0) ))+Kvect.at(24)*(gp + 8*hi[6]/9.0)-Kvect.at(25)*(gt + 19372*hi[6]*K[0]/6561.0 + (-25360*hi[6]*K[1]/2187.0) + 64448*hi[6]*K[2]/6561.0 + (-212*hi[6]*K[3]/729.0) ));
//            K[5] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(Xt + hi[6]))*(gt + 9017*hi[6]*K[0]/3168.0 + (-355*hi[6]*K[1]/33.0) + 46732*hi[6]*K[2]/5247.0 + (49*hi[6]*K[3]/176.0) + (-5103*hi[6]*K[4]/18656.0) ))/(Kvect.at(29)+(gt + 9017*hi[6]*K[0]/3168.0 + (-355*hi[6]*K[1]/33.0) + 46732*hi[6]*K[2]/5247.0 + (49*hi[6]*K[3]/176.0) + (-5103*hi[6]*K[4]/18656.0) ))+Kvect.at(24)*(gp + hi[6])-Kvect.at(25)*(gt + 9017*hi[6]*K[0]/3168.0 + (-355*hi[6]*K[1]/33.0) + 46732*hi[6]*K[2]/5247.0 + (49*hi[6]*K[3]/176.0) + (-5103*hi[6]*K[4]/18656.0) ));
//            K[6] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(Xt + hi[6]))*(gt + 35*hi[6]*K[0]/384.0 + 500*hi[6]*K[2]/1113.0 + (125*hi[6]*K[3]/192.0) + (-2187*hi[6]*K[4]/6784.0) + 11*hi[6]*K[5]/84.0))/(Kvect.at(29)+(gt + 35*hi[6]*K[0]/384.0 + 500*hi[6]*K[2]/1113.0 + (125*hi[6]*K[3]/192.0) + (-2187*hi[6]*K[4]/6784.0) + 11*hi[6]*K[5]/84.0))+Kvect.at(24)*(gp + hi[6])-Kvect.at(25)*(gt + 35*hi[6]*K[0]/384.0 + 500*hi[6]*K[2]/1113.0 + (125*hi[6]*K[3]/192.0) + (-2187*hi[6]*K[4]/6784.0) + 11*hi[6]*K[5]/84.0));
...
//            K[0] = hi[7]*(-Kvect.at(15)*(I1-Ip/Kvect.at(4)));
//            K[1] = hi[7]*(-Kvect.at(15)*((I1 + hi[7]*K[0]/5.0)-(Ip+ hi[7]/5.0)/Kvect.at(4)));
//            K[2] = hi[7]*(-Kvect.at(15)*((I1 + 3*hi[7]*K[0]/40.0 + 9*hi[7]*K[1]/40.0)-(Ip+ 3*hi[7]/10.0)/Kvect.at(4)));
//            K[3] = hi[7]*(-Kvect.at(15)*((I1 + 44*hi[7]*K[0]/45.0 + (-56*hi[7]*K[1]/15.0) + 32*hi[7]*K[2]/9.0)-(Ip+ 4*hi[7]/5.0)/Kvect.at(4)));
//            K[4] = hi[7]*(-Kvect.at(15)*((I1 + 19372*hi[7]*K[0]/6561.0 + (-25360*hi[7]*K[1]/2187.0) + 64448*hi[7]*K[2]/6561.0 + (-212*hi[7]*K[3]/729.0) )-(Ip+ 8*hi[7]/9.0)/Kvect.at(4)));
//            K[5] = hi[7]*(-Kvect.at(15)*((I1 + 9017*hi[7]*K[0]/3168.0 + (-355*hi[7]*K[1]/33.0) + 46732*hi[7]*K[2]/5247.0 + (49*hi[7]*K[3]/176.0) + (-5103*hi[7]*K[4]/18656.0) )-(Ip+ hi[7])/Kvect.at(4)));
//            K[6] = hi[7]*(-Kvect.at(15)*((I1 + 35*hi[7]*K[0]/384.0 + 500*hi[7]*K[2]/1113.0 + (125*hi[7]*K[3]/192.0) + (-2187*hi[7]*K[4]/6784.0) + 11*hi[7]*K[5]/84.0 )-(Ip+ hi[7])/Kvect.at(4)));
...
//            K[0] = hi[8]*(-Kvect.at(15)*(Id-I1));
//            K[1] =  hi[8]*(-Kvect.at(15)*((Id + hi[8]*K[0]/5.0)-(I1+hi[8]/5.0)));
//            K[2] =  hi[8]*(-Kvect.at(15)*((Id + 3*hi[8]*K[0]/40.0 + 9*hi[8]*K[1]/40.0)-(I1+3*hi[8]/10.0)));
//            K[3] =  hi[8]*(-Kvect.at(15)*((Id + 44*hi[8]*K[0]/45.0 + (-56*hi[8]*K[1]/15.0) + 32*hi[8]*K[2]/9.0)-(I1+4*hi[8]/5.0)));
//            K[4] =  hi[8]*(-Kvect.at(15)*((Id + 19372*hi[8]*K[0]/6561.0 + (-25360*hi[8]*K[1]/2187.0) + 64448*hi[8]*K[2]/6561.0 + (-212*hi[8]*K[3]/729.0))-(I1+8*hi[8]/9.0)));
//            K[5] =  hi[8]*(-Kvect.at(15)*((Id + 9017*hi[8]*K[0]/3168.0 + (-355*hi[8]*K[1]/33.0) + 46732*hi[8]*K[2]/5247.0 + (49*hi[8]*K[3]/176.0) + (-5103*hi[8]*K[4]/18656.0))-(I1+hi[8])));
//            K[6] =  hi[8]*(-Kvect.at(15)*((Id + 35*hi[8]*K[0]/384.0 + 500*hi[8]*K[2]/1113.0 + (125*hi[8]*K[3]/192.0) + (-2187*hi[8]*K[4]/6784.0) + 11*hi[8]*K[5]/84.0)-(I1+hi[8])));
...
//            if( ((Ip/Kvect.at(4))-Kvect.at(1)) < 0){
//                 Heavi2 = 0;}
//            K[0] = hi[9]*(-Kvect.at(30)*Xt+Kvect.at(30)*((Ip/Kvect.at(4))-Kvect.at(1))*Heavi2);

//            if( (((Ip+ hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) >= 0){
//                 Heavi2 = 1;}
//            if( (((Ip+ hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) < 0){
//                 Heavi2 = 0;}
//            K[1] = hi[9]*(-Kvect.at(30)*(Xt+ hi[9]*K[0]/5.0)+Kvect.at(30)*(((Ip+ hi[9]/5.0)/Kvect.at(4))-Kvect.at(1))*Heavi2);

//            if( (((Ip+ 3*hi[9]/10.0)/Kvect.at(4))-Kvect.at(1)) >= 0){
//                 Heavi2 = 1;}
//            if( (((Ip+ 3*hi[9]/10.0)/Kvect.at(4))-Kvect.at(1)) < 0){
//                 Heavi2 = 0;}
//            K[2] = hi[9]*(-Kvect.at(30)*(Xt+ 3*hi[9]*K[0]/40.0 + 9*hi[9]*K[1]/40.0)+Kvect.at(30)*(((Ip+ 3*hi[9]/10.0)/Kvect.at(4))-Kvect.at(1))*Heavi2);

//            if( (((Ip+ 4*hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) >= 0){
//                 Heavi2 = 1;}
//            if( (((Ip+ 4*hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) < 0){
//                 Heavi2 = 0;}
//            K[3] = hi[9]*(-Kvect.at(30)*(Xt+ 44*hi[9]*K[0]/45.0 + (-56*hi[9]*K[1]/15.0) + 32*hi[9]*K[2]/9.0)+Kvect.at(30)*(((Ip+ 4*hi[9]/5.0)/Kvect.at(4))-Kvect.at(1))*Heavi2);

//            if( (((Ip+ 8*hi[9]/9.0)/Kvect.at(4))-Kvect.at(1)) >= 0){
//                 Heavi2 = 1;}
//            if( (((Ip+ 8*hi[9]/9.0)/Kvect.at(4))-Kvect.at(1)) < 0){
//                 Heavi2 = 0;}
//            K[4] = hi[9]*(-Kvect.at(30)*(Xt+ 19372*hi[9]*K[0]/6561.0 + (-25360*hi[9]*K[1]/2187.0) + 64448*hi[9]*K[2]/6561.0 + (-212*hi[9]*K[3]/729.0) )+Kvect.at(30)*(((Ip+ 8*hi[9]/9.0)/Kvect.at(4))-Kvect.at(1))*Heavi2);

//            if( (((Ip+ hi[9])/Kvect.at(4))-Kvect.at(1)) >= 0){
//                 Heavi2 = 1;}
//            if( (((Ip+ hi[9])/Kvect.at(4))-Kvect.at(1)) < 0){
//                 Heavi2 = 0;}
//            K[5] = hi[9]*(-Kvect.at(30)*(Xt+ 9017*hi[9]*K[0]/3168.0 + (-355*hi[9]*K[1]/33.0) + 46732*hi[9]*K[2]/5247.0 + (49*hi[9]*K[3]/176.0) + (-5103*hi[9]*K[4]/18656.0) )+Kvect.at(30)*(((Ip+ hi[9])/Kvect.at(4))-Kvect.at(1))*Heavi2);

//            if( (((Ip+ hi[9])/Kvect.at(4))-Kvect.at(1)) >= 0){
//                 Heavi2 = 1;}
//            if( (((Ip+ hi[9])/Kvect.at(4))-Kvect.at(1)) < 0){
//                 Heavi2 = 0;}
//            K[6] = hi[9]*(-Kvect.at(30)*(Xt+ 35*hi[9]*K[0]/384.0 + 500*hi[9]*K[2]/1113.0 + (125*hi[9]*K[3]/192.0) + (-2187*hi[9]*K[4]/6784.0) + 11*hi[9]*K[5]/84.0)+Kvect.at(30)*(((Ip+ hi[9])/Kvect.at(4))-Kvect.at(1))*Heavi2);
...
//            K[0] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*Il+Kvect.at(6)*Ip);
//            K[1] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(Il+ hi[1]*K[0]/5.0)+Kvect.at(6)*(Ip+ hi[1]/5.0));
//            K[2] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(Il+ 3*hi[1]*K[0]/40.0 + 9*hi[1]*K[1]/40.0)+Kvect.at(6)*(Ip+ 3*hi[1]/10.0));
//            K[3] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(Il+ 44*hi[1]*K[0]/45.0 + (-56*hi[1]*K[1]/15.0) + 32*hi[1]*K[2]/9.0)+Kvect.at(6)*(Ip+ 4*hi[1]/5.0));
//            K[4] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(Il+ 19372*hi[1]*K[0]/6561.0 + (-25360*hi[1]*K[1]/2187.0) + 64448*hi[1]*K[2]/6561.0 + (-212*hi[1]*K[3]/729.0))+Kvect.at(6)*(Ip+ 8*hi[1]/9.0));
//            K[5] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(Il+ 9017*hi[1]*K[0]/3168.0 + (-355*hi[1]*K[1]/33.0) + 46732*hi[1]*K[2]/5247.0 + (49*hi[1]*K[3]/176.0) + (-5103*hi[1]*K[4]/18656.0))+Kvect.at(6)*(Ip+ hi[1]));
//            K[6] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(Il+ 35*hi[1]*K[0]/384.0 + 500*hi[1]*K[2]/1113.0 + (125*hi[1]*K[3]/192.0) + (-2187*hi[1]*K[4]/6784.0) + 11*hi[1]*K[5]/84.0)+Kvect.at(6)*(Ip+ hi[1]));
...
//            K[0] = hi[2]*(-Kvect.at(6)*Ip+Kvect.at(5)*Il+Kvect.at(10)/Kvect.at(0)*It-Kvect.at(9)*Ip);
//            K[1] = hi[2]*(-Kvect.at(6)*(Ip+ hi[2]*K[0]/5.0)+Kvect.at(5)*(Il+ hi[2]/5.0)+Kvect.at(10)/Kvect.at(0)*(It+ hi[2]/5.0)-Kvect.at(9)*(Ip+ hi[2]*K[0]/5.0));
//            K[2] = hi[2]*(-Kvect.at(6)*(Ip+ 3*hi[2]*K[0]/40.0 + 9*hi[2]*K[1]/40.0)+Kvect.at(5)*(Il+ 3*hi[2]/10.0)+Kvect.at(10)/Kvect.at(0)*(It+ 3*hi[2]/10.0)-Kvect.at(9)*(Ip+ 3*hi[2]*K[0]/40.0 + 9*hi[2]*K[1]/40.0));
//            K[3] = hi[2]*(-Kvect.at(6)*(Ip+ 44*hi[2]*K[0]/45.0 + (-56*hi[2]*K[1]/15.0) + 32*hi[2]*K[2]/9.0)+Kvect.at(5)*(Il+ 4*hi[2]/5.0)+Kvect.at(10)/Kvect.at(0)*(It+ 4*hi[2]/5.0)-Kvect.at(9)*(Ip+ 44*hi[2]*K[0]/45.0 + (-56*hi[2]*K[1]/15.0) + 32*hi[2]*K[2]/9.0));
//            K[4] = hi[2]*(-Kvect.at(6)*(Ip+ 19372*hi[2]*K[0]/6561.0 + (-25360*hi[2]*K[1]/2187.0) + 64448*hi[2]*K[2]/6561.0 + (-212*hi[2]*K[3]/729.0) )+Kvect.at(5)*(Il+ 8*hi[2]/9.0)+Kvect.at(10)/Kvect.at(0)*(It+ 8*hi[2]/9.0)-Kvect.at(9)*(Ip+ 19372*hi[2]*K[0]/6561.0 + (-25360*hi[2]*K[1]/2187.0) + 64448*hi[2]*K[2]/6561.0 + (-212*hi[2]*K[3]/729.0) ));
//            K[5] = hi[2]*(-Kvect.at(6)*(Ip+ 9017*hi[2]*K[0]/3168.0 + (-355*hi[2]*K[1]/33.0) + 46732*hi[2]*K[2]/5247.0 + (49*hi[2]*K[3]/176.0) + (-5103*hi[2]*K[4]/18656.0))+Kvect.at(5)*(Il+ hi[2])+Kvect.at(10)/Kvect.at(0)*(It+ hi[2])-Kvect.at(9)*(Ip+ 9017*hi[2]*K[0]/3168.0 + (-355*hi[2]*K[1]/33.0) + 46732*hi[2]*K[2]/5247.0 + (49*hi[2]*K[3]/176.0) + (-5103*hi[2]*K[4]/18656.0)));
//            K[6] = hi[2]*(-Kvect.at(6)*(Ip+ 35*hi[2]*K[0]/384.0 + 500*hi[2]*K[2]/1113.0 + (125*hi[2]*K[3]/192.0) + (-2187*hi[2]*K[4]/6784.0) + 11*hi[2]*K[5]/84.0)+Kvect.at(5)*(Il+ hi[2])+Kvect.at(10)/Kvect.at(0)*(It+ hi[2])-Kvect.at(9)*(Ip+ 35*hi[2]*K[0]/384.0 + 500*hi[2]*K[2]/1113.0 + (125*hi[2]*K[3]/192.0) + (-2187*hi[2]*K[4]/6784.0) + 11*hi[2]*K[5]/84.0));
...
////            K[0] = hi[3]*(-Kvect.at(17)*fgut+Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*(fsol+fliq-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*(fsol+fliq-Kvect.at(22)*Dig))+2)*fliq);
////            K[1] = hi[3]*(-Kvect.at(17)*(fgut+ hi[3]*K[0]/5.0)+Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ hi[3]/5.0)+(fliq+ hi[3]/5.0)-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ hi[3]/5.0)+(fliq+ hi[3]/5.0)-Kvect.at(22)*Dig))+2)*(fliq+ hi[3]/5.0));
////            K[2] = hi[3]*(-Kvect.at(17)*(fgut+ 3*hi[3]*K[0]/40.0 + 9*hi[3]*K[1]/40.0)+Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ 3*hi[3]/10.0)+(fliq+ 3*hi[3]/10.0)-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ 3*hi[3]/10.0)+(fliq+ 3*hi[3]/10.0)-Kvect.at(22)*Dig))+2)*(fliq+ 3*hi[3]/10.0));
////            K[3] = hi[3]*(-Kvect.at(17)*(fgut+ 44*hi[3]*K[0]/45.0 + (-56*hi[3]*K[1]/15.0) + 32*hi[3]*K[2]/9.0)+Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ 4*hi[3]/5.0)+(fliq+ 4*hi[3]/5.0)-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ 4*hi[3]/5.0)+(fliq+ 4*hi[3]/5.0)-Kvect.at(22)*Dig))+2)*(fliq+ 4*hi[3]/5.0));
////            K[4] = hi[3]*(-Kvect.at(17)*(fgut+ 19372*hi[3]*K[0]/6561.0 + (-25360*hi[3]*K[1]/2187.0) + 64448*hi[3]*K[2]/6561.0 + (-212*hi[3]*K[3]/729.0) )+Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ 8*hi[3]/9.0)+(fliq+ 8*hi[3]/9.0)-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ 8*hi[3]/9.0)+(fliq+ 8*hi[3]/9.0)-Kvect.at(22)*Dig))+2)*(fliq+ 8*hi[3]/9.0));
////            K[5] = hi[3]*(-Kvect.at(17)*(fgut+ 9017*hi[3]*K[0]/3168.0 + (-355*hi[3]*K[1]/33.0) + 46732*hi[3]*K[2]/5247.0 + (49*hi[3]*K[3]/176.0) + (-5103*hi[3]*K[4]/18656.0))+Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ hi[3])+(fliq+ hi[3])-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ hi[3])+(fliq+ hi[3])-Kvect.at(22)*Dig))+2)*(fliq+ hi[3]));
////            K[6] = hi[3]*(-Kvect.at(17)*(fgut+ 35*hi[3]*K[0]/384.0 + 500*hi[3]*K[2]/1113.0 + (125*hi[3]*K[3]/192.0) + (-2187*hi[3]*K[4]/6784.0) + 11*hi[3]*K[5]/84.0)+Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ hi[3])+(fliq+ hi[3])-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ hi[3])+(fliq+ hi[3])-Kvect.at(22)*Dig))+2)*(fliq+ hi[3]));

//            K[0] = hi[3]*(-Kvect.at(17)*fgut+kgut*fliq);
//            K[1] = hi[3]*(-Kvect.at(17)*(fgut+ hi[3]*K[0]/5.0)+kgut*(fliq+ hi[3]/5.0));
//            K[2] = hi[3]*(-Kvect.at(17)*(fgut+ 3*hi[3]*K[0]/40.0 + 9*hi[3]*K[1]/40.0)+kgut*(fliq+ 3*hi[3]/10.0));
//            K[3] = hi[3]*(-Kvect.at(17)*(fgut+ 44*hi[3]*K[0]/45.0 + (-56*hi[3]*K[1]/15.0) + 32*hi[3]*K[2]/9.0)+kgut*(fliq+ 4*hi[3]/5.0));
//            K[4] = hi[3]*(-Kvect.at(17)*(fgut+ 19372*hi[3]*K[0]/6561.0 + (-25360*hi[3]*K[1]/2187.0) + 64448*hi[3]*K[2]/6561.0 + (-212*hi[3]*K[3]/729.0) )+kgut*(fliq+ 8*hi[3]/9.0));
//            K[5] = hi[3]*(-Kvect.at(17)*(fgut+ 9017*hi[3]*K[0]/3168.0 + (-355*hi[3]*K[1]/33.0) + 46732*hi[3]*K[2]/5247.0 + (49*hi[3]*K[3]/176.0) + (-5103*hi[3]*K[4]/18656.0))+kgut*(fliq+ hi[3]));
//            K[6] = hi[3]*(-Kvect.at(17)*(fgut+ 35*hi[3]*K[0]/384.0 + 500*hi[3]*K[2]/1113.0 + (125*hi[3]*K[3]/192.0) + (-2187*hi[3]*K[4]/6784.0) + 11*hi[3]*K[5]/84.0)+kgut*(fliq+ hi[3]));
...
//            K[0] = hi[4]*(-kgut*fliq+Kvect.at(18)*fsol);
//            K[1] = hi[4]*(-kgut*(fliq+ hi[4]*K[0]/5.0)+Kvect.at(18)*(fsol+ hi[4]/5.0));
//            K[2] = hi[4]*(-kgut*(fliq+ 3*hi[4]*K[0]/40.0 + 9*hi[4]*K[1]/40.0)+Kvect.at(18)*(fsol+ 3*hi[4]/10.0));
//            K[3] = hi[4]*(-kgut*(fliq+ 44*hi[4]*K[0]/45.0 + (-56*hi[4]*K[1]/15.0) + 32*hi[4]*K[2]/9.0)+Kvect.at(18)*(fsol+ 4*hi[4]/5.0));
//            K[4] = hi[4]*(-kgut*(fliq+ 19372*hi[4]*K[0]/6561.0 + (-25360*hi[4]*K[1]/2187.0) + 64448*hi[4]*K[2]/6561.0 + (-212*hi[4]*K[3]/729.0))+Kvect.at(18)*(fsol+ 8*hi[4]/9.0));
//            K[5] = hi[4]*(-kgut*(fliq+ 9017*hi[4]*K[0]/3168.0 + (-355*hi[4]*K[1]/33.0) + 46732*hi[4]*K[2]/5247.0 + (49*hi[4]*K[3]/176.0) + (-5103*hi[4]*K[4]/18656.0))+Kvect.at(18)*(fsol+ hi[4]));
//            K[6] = hi[4]*(-kgut*(fliq+ 35*hi[4]*K[0]/384.0 + 500*hi[4]*K[2]/1113.0 + (125*hi[4]*K[3]/192.0) + (-2187*hi[4]*K[4]/6784.0) + 11*hi[4]*K[5]/84.0)+Kvect.at(18)*(fsol+ hi[4]));

////            K[0] = hi[4]*(-(Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*(fsol+fliq-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*(fsol+fliq-Kvect.at(22)*Dig))+2))*fliq+Kvect.at(18)*fsol);
////            K[1] = hi[4]*(-(Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ hi[4]/5.0)+(fliq+ hi[4]*K[0]/5.0)-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ hi[4]/5.0)+(fliq+ hi[4]*K[0]/5.0)-Kvect.at(22)*Dig))+2))*(fliq+ hi[4]*K[0]/5.0)+Kvect.at(18)*(fsol+ hi[4]/5.0));
////            K[2] = hi[4]*(-(Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ 3*hi[4]/10.0)+(fliq+ 3*hi[4]*K[0]/40.0 + 9*hi[4]*K[1]/40.0)-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ 3*hi[4]/10.0)+(fliq+3*hi[4]*K[0]/40.0 + 9*hi[4]*K[1]/40.0)-Kvect.at(22)*Dig))+2))*(fliq+ 3*hi[4]*K[0]/40.0 + 9*hi[4]*K[1]/40.0)+Kvect.at(18)*(fsol+ 3*hi[4]/10.0));
////            K[3] = hi[4]*(-(Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ 4*hi[4]/5.0)+(fliq+ 44*hi[4]*K[0]/45.0 + (-56*hi[4]*K[1]/15.0) + 32*hi[4]*K[2]/9.0)-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ 4*hi[4]/5.0)+(fliq+ 44*hi[4]*K[0]/45.0 + (-56*hi[4]*K[1]/15.0) + 32*hi[4]*K[2]/9.0)-Kvect.at(22)*Dig))+2))*(fliq+ 44*hi[4]*K[0]/45.0 + (-56*hi[4]*K[1]/15.0) + 32*hi[4]*K[2]/9.0)+Kvect.at(18)*(fsol+ 4*hi[4]/5.0));
////            K[4] = hi[4]*(-(Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ 8*hi[4]/9.0)+(fliq+ 19372*hi[4]*K[0]/6561.0 + (-25360*hi[4]*K[1]/2187.0) + 64448*hi[4]*K[2]/6561.0 + (-212*hi[4]*K[3]/729.0))-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ 8*hi[4]/9.0)+(fliq+ 19372*hi[4]*K[0]/6561.0 + (-25360*hi[4]*K[1]/2187.0) + 64448*hi[4]*K[2]/6561.0 + (-212*hi[4]*K[3]/729.0))-Kvect.at(22)*Dig))+2))*(fliq+ 19372*hi[4]*K[0]/6561.0 + (-25360*hi[4]*K[1]/2187.0) + 64448*hi[4]*K[2]/6561.0 + (-212*hi[4]*K[3]/729.0))+Kvect.at(18)*(fsol+ 8*hi[4]/9.0));
////            K[5] = hi[4]*(-(Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ hi[4])+(fliq+ 9017*hi[4]*K[0]/3168.0 + (-355*hi[4]*K[1]/33.0) + 46732*hi[4]*K[2]/5247.0 + (49*hi[4]*K[3]/176.0) + (-5103*hi[4]*K[4]/18656.0))-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ hi[4])+(fliq+ 9017*hi[4]*K[0]/3168.0 + (-355*hi[4]*K[1]/33.0) + 46732*hi[4]*K[2]/5247.0 + (49*hi[4]*K[3]/176.0) + (-5103*hi[4]*K[4]/18656.0))-Kvect.at(22)*Dig))+2))*(fliq+ 9017*hi[4]*K[0]/3168.0 + (-355*hi[4]*K[1]/33.0) + 46732*hi[4]*K[2]/5247.0 + (49*hi[4]*K[3]/176.0) + (-5103*hi[4]*K[4]/18656.0))+Kvect.at(18)*(fsol+ hi[4]));
////            K[6] = hi[4]*(-(Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2*(tanh((5/(2*Dig*(1-Kvect.at(21))))*((fsol+ hi[4])+(fliq+ 35*hi[4]*K[0]/384.0 + 500*hi[4]*K[2]/1113.0 + (125*hi[4]*K[3]/192.0) + (-2187*hi[4]*K[4]/6784.0) + 11*hi[4]*K[5]/84.0)-Kvect.at(21)*Dig))-tanh((5/(2*Dig*Kvect.at(22)))*((fsol+ hi[4])+(fliq+ 35*hi[4]*K[0]/384.0 + 500*hi[4]*K[2]/1113.0 + (125*hi[4]*K[3]/192.0) + (-2187*hi[4]*K[4]/6784.0) + 11*hi[4]*K[5]/84.0)-Kvect.at(22)*Dig))+2))*(fliq+ 35*hi[4]*K[0]/384.0 + 500*hi[4]*K[2]/1113.0 + (125*hi[4]*K[3]/192.0) + (-2187*hi[4]*K[4]/6784.0) + 11*hi[4]*K[5]/84.0)+Kvect.at(18)*(fsol+ hi[4]));
...
//            K[0] = hi[5]*(-Kvect.at(18)*fsol+vm);
//            K[1] = hi[5]*(-Kvect.at(18)*(fsol+ hi[5]*K[0]/5.0)+(vm));
//            K[2] = hi[5]*(-Kvect.at(18)*(fsol+ 3*hi[5]*K[0]/40.0 + 9*hi[5]*K[1]/40.0)+(vm));
//            K[3] = hi[5]*(-Kvect.at(18)*(fsol+ 44*hi[5]*K[0]/45.0 + (-56*hi[5]*K[1]/15.0) + 32*hi[5]*K[2]/9.0)+(vm));
//            K[4] = hi[5]*(-Kvect.at(18)*(fsol+ 19372*hi[5]*K[0]/6561.0 + (-25360*hi[5]*K[1]/2187.0) + 64448*hi[5]*K[2]/6561.0 + (-212*hi[5]*K[3]/729.0))+(vm));
//            K[5] = hi[5]*(-Kvect.at(18)*(fsol+ 9017*hi[5]*K[0]/3168.0 + (-355*hi[5]*K[1]/33.0) + 46732*hi[5]*K[2]/5247.0 + (49*hi[5]*K[3]/176.0) + (-5103*hi[5]*K[4]/18656.0))+(vm));
//            K[6] = hi[5]*(-Kvect.at(18)*(fsol+ 35*hi[5]*K[0]/384.0 + 500*hi[5]*K[2]/1113.0 + (125*hi[5]*K[3]/192.0) + (-2187*hi[5]*K[4]/6784.0) + 11*hi[5]*K[5]/84.0)+(vm));
...
//            if( (-dgp) < 0){
//                 Heavi6 = 0;}
//            K[0] = hi[10]*(-Kvect.at(33)*Ipo+(Yt+Kvect.at(3))*Heavi5+(Yt+Kvect.at(3))*(Heavi6));

//            K[1] = hi[10]*(-Kvect.at(33)*(Ipo+ hi[10]*K[0]/5.0)+((Yt+ hi[10]/5.0)+Kvect.at(3))*Heavi5+((Yt+ hi[10]/5.0)+Kvect.at(3))*(Heavi6));

//            K[2] = hi[10]*(-Kvect.at(33)*(Ipo+ 3*hi[10]*K[0]/40.0 + 9*hi[10]*K[1]/40.0)+((Yt+ 3*hi[10]/10.0)+Kvect.at(3))*Heavi5+((Yt+ 3*hi[10]/10.0)+Kvect.at(3))*(Heavi6));

//            K[3] = hi[10]*(-Kvect.at(33)*(Ipo+ 44*hi[10]*K[0]/45.0 + (-56*hi[10]*K[1]/15.0) + 32*hi[10]*K[2]/9.0)+((Yt+ 4*hi[10]/5.0)+Kvect.at(3))*Heavi5+((Yt+ 4*hi[10]/5.0)+Kvect.at(3))*(Heavi6));

//            K[4] = hi[10]*(-Kvect.at(33)*(Ipo+ 19372*hi[10]*K[0]/6561.0 + (-25360*hi[10]*K[1]/2187.0) + 64448*hi[10]*K[2]/6561.0 + (-212*hi[10]*K[3]/729.0))+((Yt+ 8*hi[10]/9.0)+Kvect.at(3))*Heavi5+((Yt+ 8*hi[10]/9.0)+Kvect.at(3))*(Heavi6));

//            K[5] = hi[10]*(-Kvect.at(33)*(Ipo+ 9017*hi[10]*K[0]/3168.0 + (-355*hi[10]*K[1]/33.0) + 46732*hi[10]*K[2]/5247.0 + (49*hi[10]*K[3]/176.0) + (-5103*hi[10]*K[4]/18656.0))+((Yt+ hi[10])+Kvect.at(3))*Heavi5+((Yt+ hi[10])+Kvect.at(3))*(Heavi6));

//            K[6] = hi[10]*(-Kvect.at(33)*(Ipo+ 35*hi[10]*K[0]/384.0 + 500*hi[10]*K[2]/1113.0 + (125*hi[10]*K[3]/192.0) + (-2187*hi[10]*K[4]/6784.0) + 11*hi[10]*K[5]/84.0)+((Yt+ hi[10])+Kvect.at(3))*Heavi5+((Yt+ hi[10])+Kvect.at(3))*(Heavi6));
...
//            if( (-Kvect.at(3)-Kvect.at(35)*(gp/Kvect.at(23)-Kvect.at(2))) < 0){
//                 Heavi8 = 0;}
//            K[0] = hi[11]*(-Kvect.at(34)*(Yt-Kvect.at(35)*(gp/Kvect.at(23)-Kvect.at(2)))*Heavi7+(-Kvect.at(34)*Yt-Kvect.at(34)*Kvect.at(3))*(Heavi8));

//            if( (Kvect.at(35)*((gp+ hi[11]/5.0)/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) >= 0){
//                 Heavi7 = 1;}
//            if( (Kvect.at(35)*((gp+ hi[11]/5.0)/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) < 0){
//                 Heavi7 = 0;}

//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ hi[11]/5.0)/Kvect.at(23)-Kvect.at(2))) >= 0){
//                 Heavi8 = 1;}
//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ hi[11]/5.0)/Kvect.at(23)-Kvect.at(2))) < 0){
//                 Heavi8 = 0;}
//            K[1] = hi[11]*(-Kvect.at(34)*((Yt+ hi[11]*K[0]/5.0)-Kvect.at(35)*((gp+ hi[11]/5.0)/Kvect.at(23)-Kvect.at(2)))*Heavi7+(-Kvect.at(34)*(Yt+ hi[11]*K[0]/5.0)-Kvect.at(34)*Kvect.at(3))*(Heavi8));

//            if( (Kvect.at(35)*((gp+ 3*hi[11]/10.0)/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) >= 0){
//                 Heavi7 = 1;}
//            if( (Kvect.at(35)*((gp+ 3*hi[11]/10.0)/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) < 0){
//                 Heavi7 = 0;}

//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ 3*hi[11]/10.0)/Kvect.at(23)-Kvect.at(2))) >= 0){
//                 Heavi8 = 1;}
//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ 3*hi[11]/10.0)/Kvect.at(23)-Kvect.at(2))) < 0){
//                 Heavi8 = 0;}
//            K[2] = hi[11]*(-Kvect.at(34)*((Yt+ 3*hi[11]*K[0]/40.0 + 9*hi[11]*K[1]/40.0)-Kvect.at(35)*((gp+ 3*hi[11]/10.0)/Kvect.at(23)-Kvect.at(2)))*Heavi7+(-Kvect.at(34)*(Yt+ 3*hi[11]*K[0]/40.0 + 9*hi[11]*K[1]/40.0)-Kvect.at(34)*Kvect.at(3))*(Heavi8));

//            if( (Kvect.at(35)*((gp+ 4*hi[11]/5.0)/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) >= 0){
//                 Heavi7 = 1;}
//            if( (Kvect.at(35)*((gp+ 4*hi[11]/5.0)/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) < 0){
//                 Heavi7 = 0;}

//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ 4*hi[11]/5.0)/Kvect.at(23)-Kvect.at(2))) >= 0){
//                 Heavi8 = 1;}
//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ 4*hi[11]/5.0)/Kvect.at(23)-Kvect.at(2))) < 0){
//                 Heavi8 = 0;}
//            K[3] = hi[11]*(-Kvect.at(34)*((Yt+ 44*hi[11]*K[0]/45.0 + (-56*hi[11]*K[1]/15.0) + 32*hi[11]*K[2]/9.0)-Kvect.at(35)*((gp+ 4*hi[11]/5.0)/Kvect.at(23)-Kvect.at(2)))*Heavi7+(-Kvect.at(34)*(Yt+ 44*hi[11]*K[0]/45.0 + (-56*hi[11]*K[1]/15.0) + 32*hi[11]*K[2]/9.0)-Kvect.at(34)*Kvect.at(3))*(Heavi8));

//            if( (Kvect.at(35)*((gp+ 8*hi[11]/9.0)/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) >= 0){
//                 Heavi7 = 1;}
//            if( (Kvect.at(35)*((gp+ 8*hi[11]/9.0)/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) < 0){
//                 Heavi7 = 0;}

//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ 8*hi[11]/9.0)/Kvect.at(23)-Kvect.at(2))) >= 0){
//                 Heavi8 = 1;}
//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ 8*hi[11]/9.0)/Kvect.at(23)-Kvect.at(2))) < 0){
//                 Heavi8 = 0;}
//            K[4] = hi[11]*(-Kvect.at(34)*((Yt+ 19372*hi[11]*K[0]/6561.0 + (-25360*hi[11]*K[1]/2187.0) + 64448*hi[11]*K[2]/6561.0 + (-212*hi[11]*K[3]/729.0))-Kvect.at(35)*((gp+ 8*hi[11]/9.0)/Kvect.at(23)-Kvect.at(2)))*Heavi7+(-Kvect.at(34)*(Yt+ 19372*hi[11]*K[0]/6561.0 + (-25360*hi[11]*K[1]/2187.0) + 64448*hi[11]*K[2]/6561.0 + (-212*hi[11]*K[3]/729.0))-Kvect.at(34)*Kvect.at(3))*(Heavi8));

//            if( (Kvect.at(35)*((gp+ hi[11])/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) >= 0){
//                 Heavi7 = 1;}
//            if( (Kvect.at(35)*((gp+ hi[11])/Kvect.at(23)-Kvect.at(2))+Kvect.at(3)) < 0){
//                 Heavi7 = 0;}

//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ hi[11])/Kvect.at(23)-Kvect.at(2))) >= 0){
//                 Heavi8 = 1;}
//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ hi[11])/Kvect.at(23)-Kvect.at(2))) < 0){
//                 Heavi8 = 0;}
//            K[5] = hi[11]*(-Kvect.at(34)*((Yt+ 9017*hi[11]*K[0]/3168.0 + (-355*hi[11]*K[1]/33.0) + 46732*hi[11]*K[2]/5247.0 + (49*hi[11]*K[3]/176.0) + (-5103*hi[11]*K[4]/18656.0))-Kvect.at(35)*((gp+ hi[11])/Kvect.at(23)-Kvect.at(2)))*Heavi7+(-Kvect.at(34)*(Yt+ 9017*hi[11]*K[0]/3168.0 + (-355*hi[11]*K[1]/33.0) + 46732*hi[11]*K[2]/5247.0 + (49*hi[11]*K[3]/176.0) + (-5103*hi[11]*K[4]/18656.0))-Kvect.at(34)*Kvect.at(3))*(Heavi8));
...
//            if( (-Kvect.at(3)-Kvect.at(35)*((gp+ hi[11])/Kvect.at(23)-Kvect.at(2))) < 0){
//                 Heavi8 = 0;}
//            K[6] = hi[11]*(-Kvect.at(34)*((Yt+ 35*hi[11]*K[0]/384.0 + 500*hi[11]*K[2]/1113.0 + (125*hi[11]*K[3]/192.0) + (-2187*hi[11]*K[4]/6784.0) + 11*hi[11]*K[5]/84.0)-Kvect.at(35)*((gp+ hi[11])/Kvect.at(23)-Kvect.at(2)))*Heavi7+(-Kvect.at(34)*(Yt+ 35*hi[11]*K[0]/384.0 + 500*hi[11]*K[2]/1113.0 + (125*hi[11]*K[3]/192.0) + (-2187*hi[11]*K[4]/6784.0) + 11*hi[11]*K[5]/84.0)-Kvect.at(34)*Kvect.at(3))*(Heavi8));
...
//            K[0] = hi[13]*(Kvect.at(8)*Ii-Kvect.at(10)*It);
//            K[1] = hi[13]*(Kvect.at(8)*(Ii+ hi[13]/5.0)-Kvect.at(10)*(It+ hi[13]*K[0]/5.0));
//            K[2] = hi[13]*(Kvect.at(8)*(Ii+ 3*hi[13]/10.0)-Kvect.at(10)*(It+ 3*hi[13]*K[0]/40.0 + 9*hi[13]*K[1]/40.0));
//            K[3] = hi[13]*(Kvect.at(8)*(Ii+ 4*hi[13]/5.0)-Kvect.at(10)*(It+ 44*hi[13]*K[0]/45.0 + (-56*hi[13]*K[1]/15.0) + 32*hi[13]*K[2]/9.0));
//            K[4] = hi[13]*(Kvect.at(8)*(Ii+ 8*hi[13]/9.0)-Kvect.at(10)*(It+ 19372*hi[13]*K[0]/6561.0 + (-25360*hi[13]*K[1]/2187.0) + 64448*hi[13]*K[2]/6561.0 + (-212*hi[13]*K[3]/729.0)));
//            K[5] = hi[13]*(Kvect.at(8)*(Ii+ hi[13])-Kvect.at(10)*(It+ 9017*hi[13]*K[0]/3168.0 + (-355*hi[13]*K[1]/33.0) + 46732*hi[13]*K[2]/5247.0 + (49*hi[13]*K[3]/176.0) + (-5103*hi[13]*K[4]/18656.0)));
//            K[6] = hi[13]*(Kvect.at(8)*(Ii+ hi[13])-Kvect.at(10)*(It+ 35*hi[13]*K[0]/384.0 + 500*hi[13]*K[2]/1113.0 + (125*hi[13]*K[3]/192.0) + (-2187*hi[13]*K[4]/6784.0) + 11*hi[13]*K[5]/84.0));
...
//            K[0] = hi[12]*(-Kvect.at(8)*Ii+vbas+vbol);
//            K[1] = hi[12]*(-Kvect.at(8)*(Ii+ hi[12]*K[0]/5.0)+vbas+vbol);
//            K[2] = hi[12]*(-Kvect.at(8)*(Ii+ 3*hi[12]*K[0]/40.0 + 9*hi[12]*K[1]/40.0)+(vbas)+vbol);
//            K[3] = hi[12]*(-Kvect.at(8)*(Ii+ 44*hi[12]*K[0]/45.0 + (-56*hi[12]*K[1]/15.0) + 32*hi[12]*K[2]/9.0)+(vbas)+vbol);
//            K[4] = hi[12]*(-Kvect.at(8)*(Ii+ 19372*hi[12]*K[0]/6561.0 + (-25360*hi[12]*K[1]/2187.0) + 64448*hi[12]*K[2]/6561.0 + (-212*hi[12]*K[3]/729.0))+(vbas)+(vbol));
//            K[5] = hi[12]*(-Kvect.at(8)*(Ii+ 9017*hi[12]*K[0]/3168.0 + (-355*hi[12]*K[1]/33.0) + 46732*hi[12]*K[2]/5247.0 + (49*hi[12]*K[3]/176.0) + (-5103*hi[12]*K[4]/18656.0))+(vbas)+(vbol));
//            K[6] = hi[12]*(-Kvect.at(8)*(Ii+ 35*hi[12]*K[0]/384.0 + 500*hi[12]*K[2]/1113.0 + (125*hi[12]*K[3]/192.0) + (-2187*hi[12]*K[4]/6784.0) + 11*hi[12]*K[5]/84.0)+(vbas)+(vbol));
...
void MainWindow::DormanPrince(int *i)
{
    ...
    double Ti3 = 10.0;
    double ti3 = 10.0;
    double tm1 = 60.0; // tm  // время приёма пищи
    double Tm = 20.0;         // длительность приёма пищи
...

    {
        ...
        double bol1=1.0/Ti1*Dbol1*(1.0/(1.0+exp(-3.0*(t+10.0-ti1))))*(1.0/(1.0+exp(-3.0*(-10.0+ti1-t+Ti1))));
        double bol2=1.0/Ti2*Dbol2*(1.0/(1.0+exp(-3.0*(t+10.0-ti2))))*(1.0/(1.0+exp(-3.0*(-10.0+ti2-t+Ti2))));
        double bol3=1.0/Ti3*Dbol3*(1.0/(1.0+exp(-3.0*(t+10.0-ti3))))*(1.0/(1.0+exp(-3.0*(-10.0+ti3-t+Ti3))));

        double vbol=6000*(bol1+bol2+bol3);

        double vm=Dig/Tm*(1.0/(1.0+exp(-3.0*(t-tm1))))*(1.0/(1.0+exp(-3.0*(-(t-tm1-Tm)))));
        ...
        double kgut;
        kgut=Kvect.at(19)+(Kvect.at(20)-Kvect.at(19))/2.0*(tanh((5.0/(2.0*Dig*(1.0-Kvect.at(21))))*(dZ[4]+dZ[5]-Kvect.at(21)*Dig))-tanh((5.0/(2.0*Dig*Kvect.at(22)))*(dZ[4]+dZ[5]-Kvect.at(22)*Dig))+2.0);
        ...
        K[0] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*DdZ[11]+Kvect.at(6)*DdZ[9]);
        K[1] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(DdZ[11]+ hi[1]*K[0]/5.0)+Kvect.at(6)*(DdZ[9]+ hi[1]/5.0));
        K[2] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(DdZ[11]+ 3*hi[1]*K[0]/40.0 + 9*hi[1]*K[1]/40.0)+Kvect.at(6)*(DdZ[9]+ 3*hi[1]/10.0));
        K[3] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(DdZ[11]+ 44*hi[1]*K[0]/45.0 + (-56*hi[1]*K[1]/15.0) + 32*hi[1]*K[2]/9.0)+Kvect.at(6)*(DdZ[9]+ 4*hi[1]/5.0));
        K[4] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(DdZ[11]+ 19372*hi[1]*K[0]/6561.0 + (-25360*hi[1]*K[1]/2187.0) + 64448*hi[1]*K[2]/6561.0 + (-212*hi[1]*K[3]/729.0))+Kvect.at(6)*(DdZ[9]+ 8*hi[1]/9.0));
        K[5] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(DdZ[11]+ 9017*hi[1]*K[0]/3168.0 + (-355*hi[1]*K[1]/33.0) + 46732*hi[1]*K[2]/5247.0 + (49*hi[1]*K[3]/176.0) + (-5103*hi[1]*K[4]/18656.0))+Kvect.at(6)*(DdZ[9]+ hi[1]));
        K[6] = hi[1]*(-(Kvect.at(5)+Kvect.at(7))*(DdZ[11]+ 35*hi[1]*K[0]/384.0 + 500*hi[1]*K[2]/1113.0 + (125*hi[1]*K[3]/192.0) + (-2187*hi[1]*K[4]/6784.0) + 11*hi[1]*K[5]/84.0)+Kvect.at(6)*(DdZ[9]+ hi[1]));

        dIl   = DdZ[11] + (35*K[0]/384.0 + 500*K[2]/1113.0 + 125*K[3]/192.0 - 2187*K[4]/6784.0 + 11*K[5]/84.0);
        ...
        K[0] = hi[2]*(-Kvect.at(6)*DdZ[9]+Kvect.at(5)*DdZ[11]+Kvect.at(10)/Kvect.at(0)*DdZ[10]-Kvect.at(9)*DdZ[9]);
        K[1] = hi[2]*(-Kvect.at(6)*(DdZ[9]+ hi[2]*K[0]/5.0)+Kvect.at(5)*(DdZ[11]+ hi[2]/5.0)+Kvect.at(10)/Kvect.at(0)*(DdZ[10]+ hi[2]/5.0)-Kvect.at(9)*(DdZ[9]+ hi[2]*K[0]/5.0));
        K[2] = hi[2]*(-Kvect.at(6)*(DdZ[9]+ 3*hi[2]*K[0]/40.0 + 9*hi[2]*K[1]/40.0)+Kvect.at(5)*(DdZ[11]+ 3*hi[2]/10.0)+Kvect.at(10)/Kvect.at(0)*(DdZ[10]+ 3*hi[2]/10.0)-Kvect.at(9)*(DdZ[9]+ 3*hi[2]*K[0]/40.0 + 9*hi[2]*K[1]/40.0));
        K[3] = hi[2]*(-Kvect.at(6)*(DdZ[9]+ 44*hi[2]*K[0]/45.0 + (-56*hi[2]*K[1]/15.0) + 32*hi[2]*K[2]/9.0)+Kvect.at(5)*(DdZ[11]+ 4*hi[2]/5.0)+Kvect.at(10)/Kvect.at(0)*(DdZ[10]+ 4*hi[2]/5.0)-Kvect.at(9)*(DdZ[9]+ 44*hi[2]*K[0]/45.0 + (-56*hi[2]*K[1]/15.0) + 32*hi[2]*K[2]/9.0));
        K[4] = hi[2]*(-Kvect.at(6)*(DdZ[9]+ 19372*hi[2]*K[0]/6561.0 + (-25360*hi[2]*K[1]/2187.0) + 64448*hi[2]*K[2]/6561.0 + (-212*hi[2]*K[3]/729.0) )+Kvect.at(5)*(DdZ[11]+ 8*hi[2]/9.0)+Kvect.at(10)/Kvect.at(0)*(DdZ[10]+ 8*hi[2]/9.0)-Kvect.at(9)*(DdZ[9]+ 19372*hi[2]*K[0]/6561.0 + (-25360*hi[2]*K[1]/2187.0) + 64448*hi[2]*K[2]/6561.0 + (-212*hi[2]*K[3]/729.0) ));
        K[5] = hi[2]*(-Kvect.at(6)*(DdZ[9]+ 9017*hi[2]*K[0]/3168.0 + (-355*hi[2]*K[1]/33.0) + 46732*hi[2]*K[2]/5247.0 + (49*hi[2]*K[3]/176.0) + (-5103*hi[2]*K[4]/18656.0))+Kvect.at(5)*(DdZ[11]+ hi[2])+Kvect.at(10)/Kvect.at(0)*(DdZ[10]+ hi[2])-Kvect.at(9)*(DdZ[9]+ 9017*hi[2]*K[0]/3168.0 + (-355*hi[2]*K[1]/33.0) + 46732*hi[2]*K[2]/5247.0 + (49*hi[2]*K[3]/176.0) + (-5103*hi[2]*K[4]/18656.0)));
        K[6] = hi[2]*(-Kvect.at(6)*(DdZ[9]+ 35*hi[2]*K[0]/384.0 + 500*hi[2]*K[2]/1113.0 + (125*hi[2]*K[3]/192.0) + (-2187*hi[2]*K[4]/6784.0) + 11*hi[2]*K[5]/84.0)+Kvect.at(5)*(DdZ[11]+ hi[2])+Kvect.at(10)/Kvect.at(0)*(DdZ[10]+ hi[2])-Kvect.at(9)*(DdZ[9]+ 35*hi[2]*K[0]/384.0 + 500*hi[2]*K[2]/1113.0 + (125*hi[2]*K[3]/192.0) + (-2187*hi[2]*K[4]/6784.0) + 11*hi[2]*K[5]/84.0));
        ...
        K[0] = hi[3]*(-Kvect.at(17)*DdZ[3]+kgut*DdZ[5]);
        K[1] = hi[3]*(-Kvect.at(17)*(DdZ[3]+ hi[3]*K[0]/5.0)+kgut*(DdZ[5]+ hi[3]/5.0));
        K[2] = hi[3]*(-Kvect.at(17)*(DdZ[3]+ 3*hi[3]*K[0]/40.0 + 9*hi[3]*K[1]/40.0)+kgut*(DdZ[5]+ 3*hi[3]/10.0));
        K[3] = hi[3]*(-Kvect.at(17)*(DdZ[3]+ 44*hi[3]*K[0]/45.0 + (-56*hi[3]*K[1]/15.0) + 32*hi[3]*K[2]/9.0)+kgut*(DdZ[5]+ 4*hi[3]/5.0));
        K[4] = hi[3]*(-Kvect.at(17)*(DdZ[3]+ 19372*hi[3]*K[0]/6561.0 + (-25360*hi[3]*K[1]/2187.0) + 64448*hi[3]*K[2]/6561.0 + (-212*hi[3]*K[3]/729.0) )+kgut*(DdZ[5]+ 8*hi[3]/9.0));
        K[5] = hi[3]*(-Kvect.at(17)*(DdZ[3]+ 9017*hi[3]*K[0]/3168.0 + (-355*hi[3]*K[1]/33.0) + 46732*hi[3]*K[2]/5247.0 + (49*hi[3]*K[3]/176.0) + (-5103*hi[3]*K[4]/18656.0))+kgut*(DdZ[5]+ hi[3]));
        K[6] = hi[3]*(-Kvect.at(17)*(DdZ[3]+ 35*hi[3]*K[0]/384.0 + 500*hi[3]*K[2]/1113.0 + (125*hi[3]*K[3]/192.0) + (-2187*hi[3]*K[4]/6784.0) + 11*hi[3]*K[5]/84.0)+kgut*(DdZ[5]+ hi[3]));
        ...
        K[0] = hi[4]*(-kgut*DdZ[5]+Kvect.at(18)*DdZ[4]);
        K[1] = hi[4]*(-kgut*(DdZ[5]+ hi[4]*K[0]/5.0)+Kvect.at(18)*(DdZ[4]+ hi[4]/5.0));
        K[2] = hi[4]*(-kgut*(DdZ[5]+ 3*hi[4]*K[0]/40.0 + 9*hi[4]*K[1]/40.0)+Kvect.at(18)*(DdZ[4]+ 3*hi[4]/10.0));
        K[3] = hi[4]*(-kgut*(DdZ[5]+ 44*hi[4]*K[0]/45.0 + (-56*hi[4]*K[1]/15.0) + 32*hi[4]*K[2]/9.0)+Kvect.at(18)*(DdZ[4]+ 4*hi[4]/5.0));
        K[4] = hi[4]*(-kgut*(DdZ[5]+ 19372*hi[4]*K[0]/6561.0 + (-25360*hi[4]*K[1]/2187.0) + 64448*hi[4]*K[2]/6561.0 + (-212*hi[4]*K[3]/729.0))+Kvect.at(18)*(DdZ[4]+ 8*hi[4]/9.0));
        K[5] = hi[4]*(-kgut*(DdZ[5]+ 9017*hi[4]*K[0]/3168.0 + (-355*hi[4]*K[1]/33.0) + 46732*hi[4]*K[2]/5247.0 + (49*hi[4]*K[3]/176.0) + (-5103*hi[4]*K[4]/18656.0))+Kvect.at(18)*(DdZ[4]+ hi[4]));
        K[6] = hi[4]*(-kgut*(DdZ[5]+ 35*hi[4]*K[0]/384.0 + 500*hi[4]*K[2]/1113.0 + (125*hi[4]*K[3]/192.0) + (-2187*hi[4]*K[4]/6784.0) + 11*hi[4]*K[5]/84.0)+Kvect.at(18)*(DdZ[4]+ hi[4]));
        ...
        K[0] = hi[5]*(-Kvect.at(18)*DdZ[4]+vm);
        K[1] = hi[5]*(-Kvect.at(18)*(DdZ[4]+ hi[5]*K[0]/5.0)+(vm));
        K[2] = hi[5]*(-Kvect.at(18)*(DdZ[4]+ 3*hi[5]*K[0]/40.0 + 9*hi[5]*K[1]/40.0)+(vm));
        K[3] = hi[5]*(-Kvect.at(18)*(DdZ[4]+ 44*hi[5]*K[0]/45.0 + (-56*hi[5]*K[1]/15.0) + 32*hi[5]*K[2]/9.0)+(vm));
        K[4] = hi[5]*(-Kvect.at(18)*(DdZ[4]+ 19372*hi[5]*K[0]/6561.0 + (-25360*hi[5]*K[1]/2187.0) + 64448*hi[5]*K[2]/6561.0 + (-212*hi[5]*K[3]/729.0))+(vm));
        K[5] = hi[5]*(-Kvect.at(18)*(DdZ[4]+ 9017*hi[5]*K[0]/3168.0 + (-355*hi[5]*K[1]/33.0) + 46732*hi[5]*K[2]/5247.0 + (49*hi[5]*K[3]/176.0) + (-5103*hi[5]*K[4]/18656.0))+(vm));
        K[6] = hi[5]*(-Kvect.at(18)*(DdZ[4]+ 35*hi[5]*K[0]/384.0 + 500*hi[5]*K[2]/1113.0 + (125*hi[5]*K[3]/192.0) + (-2187*hi[5]*K[4]/6784.0) + 11*hi[5]*K[5]/84.0)+(vm));
        ...
        K[0] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*DdZ[7])*DdZ[6])/(Kvect.at(29)+DdZ[6])+Kvect.at(24)*DdZ[0]-Kvect.at(25)*DdZ[6]);
        K[1] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(DdZ[7] + hi[6]/5.0))*(DdZ[6] + hi[6]*K[0]/5.0))/(Kvect.at(29)+(DdZ[6] + hi[6]*K[0]/5.0))+Kvect.at(24)*(DdZ[0] + hi[6]/5.0)-Kvect.at(25)*(DdZ[6] + hi[6]*K[0]/5.0));
        K[2] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(DdZ[7] + 3*hi[6]/10.0))*(DdZ[6] + 3*hi[6]*K[0]/40.0 + 9*hi[6]*K[1]/40.0))/(Kvect.at(29)+(DdZ[6] + 3*hi[6]*K[0]/40.0 + 9*hi[6]*K[1]/40.0))+Kvect.at(24)*(DdZ[0] + 3*hi[6]/10.0)-Kvect.at(25)*(DdZ[6] + 3*hi[6]*K[0]/40.0 + 9*hi[6]*K[1]/40.0));
        K[3] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(DdZ[7] + 4*hi[6]/5.0))*(DdZ[6] + 44*hi[6]*K[0]/45.0 + (-56*hi[6]*K[1]/15.0) + 32*hi[6]*K[2]/9.0))/(Kvect.at(29)+(DdZ[6] + 44*hi[6]*K[0]/45.0 + (-56*hi[6]*K[1]/15.0) + 32*hi[6]*K[2]/9.0))+Kvect.at(24)*(DdZ[0] + 4*hi[6]/5.0)-Kvect.at(25)*(DdZ[6] + 44*hi[6]*K[0]/45.0 + (-56*hi[6]*K[1]/15.0) + 32*hi[6]*K[2]/9.0));
        K[4] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(DdZ[7] + 8*hi[6]/9.0))*(DdZ[6] + 19372*hi[6]*K[0]/6561.0 + (-25360*hi[6]*K[1]/2187.0) + 64448*hi[6]*K[2]/6561.0 + (-212*hi[6]*K[3]/729.0) ))/(Kvect.at(29)+(DdZ[6] + 19372*hi[6]*K[0]/6561.0 + (-25360*hi[6]*K[1]/2187.0) + 64448*hi[6]*K[2]/6561.0 + (-212*hi[6]*K[3]/729.0) ))+Kvect.at(24)*(DdZ[0] + 8*hi[6]/9.0)-Kvect.at(25)*(DdZ[6] + 19372*hi[6]*K[0]/6561.0 + (-25360*hi[6]*K[1]/2187.0) + 64448*hi[6]*K[2]/6561.0 + (-212*hi[6]*K[3]/729.0) ));
        K[5] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(DdZ[7] + hi[6]))*(DdZ[6] + 9017*hi[6]*K[0]/3168.0 + (-355*hi[6]*K[1]/33.0) + 46732*hi[6]*K[2]/5247.0 + (49*hi[6]*K[3]/176.0) + (-5103*hi[6]*K[4]/18656.0) ))/(Kvect.at(29)+(DdZ[6] + 9017*hi[6]*K[0]/3168.0 + (-355*hi[6]*K[1]/33.0) + 46732*hi[6]*K[2]/5247.0 + (49*hi[6]*K[3]/176.0) + (-5103*hi[6]*K[4]/18656.0) ))+Kvect.at(24)*(DdZ[0] + hi[6])-Kvect.at(25)*(DdZ[6] + 9017*hi[6]*K[0]/3168.0 + (-355*hi[6]*K[1]/33.0) + 46732*hi[6]*K[2]/5247.0 + (49*hi[6]*K[3]/176.0) + (-5103*hi[6]*K[4]/18656.0) ));
        K[6] = hi[6]*(-((Kvect.at(27)+Kvect.at(28)*(DdZ[7] + hi[6]))*(DdZ[6] + 35*hi[6]*K[0]/384.0 + 500*hi[6]*K[2]/1113.0 + (125*hi[6]*K[3]/192.0) + (-2187*hi[6]*K[4]/6784.0) + 11*hi[6]*K[5]/84.0))/(Kvect.at(29)+(DdZ[6] + 35*hi[6]*K[0]/384.0 + 500*hi[6]*K[2]/1113.0 + (125*hi[6]*K[3]/192.0) + (-2187*hi[6]*K[4]/6784.0) + 11*hi[6]*K[5]/84.0))+Kvect.at(24)*(DdZ[0] + hi[6])-Kvect.at(25)*(DdZ[6] + 35*hi[6]*K[0]/384.0 + 500*hi[6]*K[2]/1113.0 + (125*hi[6]*K[3]/192.0) + (-2187*hi[6]*K[4]/6784.0) + 11*hi[6]*K[5]/84.0));
        ...
        K[0] = hi[7]*(-Kvect.at(15)*(DdZ[8]-DdZ[9]/Kvect.at(4)));
        K[1] = hi[7]*(-Kvect.at(15)*((DdZ[8] + hi[7]*K[0]/5.0)-(DdZ[9]+ hi[7]/5.0)/Kvect.at(4)));
        K[2] = hi[7]*(-Kvect.at(15)*((DdZ[8] + 3*hi[7]*K[0]/40.0 + 9*hi[7]*K[1]/40.0)-(DdZ[9]+ 3*hi[7]/10.0)/Kvect.at(4)));
        K[3] = hi[7]*(-Kvect.at(15)*((DdZ[8] + 44*hi[7]*K[0]/45.0 + (-56*hi[7]*K[1]/15.0) + 32*hi[7]*K[2]/9.0)-(DdZ[9]+ 4*hi[7]/5.0)/Kvect.at(4)));
        K[4] = hi[7]*(-Kvect.at(15)*((DdZ[8] + 19372*hi[7]*K[0]/6561.0 + (-25360*hi[7]*K[1]/2187.0) + 64448*hi[7]*K[2]/6561.0 + (-212*hi[7]*K[3]/729.0) )-(DdZ[9]+ 8*hi[7]/9.0)/Kvect.at(4)));
        K[5] = hi[7]*(-Kvect.at(15)*((DdZ[8] + 9017*hi[7]*K[0]/3168.0 + (-355*hi[7]*K[1]/33.0) + 46732*hi[7]*K[2]/5247.0 + (49*hi[7]*K[3]/176.0) + (-5103*hi[7]*K[4]/18656.0) )-(DdZ[9]+ hi[7])/Kvect.at(4)));
        K[6] = hi[7]*(-Kvect.at(15)*((DdZ[8] + 35*hi[7]*K[0]/384.0 + 500*hi[7]*K[2]/1113.0 + (125*hi[7]*K[3]/192.0) + (-2187*hi[7]*K[4]/6784.0) + 11*hi[7]*K[5]/84.0 )-(DdZ[9]+ hi[7])/Kvect.at(4)));
        ...
        K[0] = hi[8]*(-Kvect.at(15)*(DdZ[1]-DdZ[8]));
        K[1] =  hi[8]*(-Kvect.at(15)*((DdZ[1] + hi[8]*K[0]/5.0)-(DdZ[8]+hi[8]/5.0)));
        K[2] =  hi[8]*(-Kvect.at(15)*((DdZ[1] + 3*hi[8]*K[0]/40.0 + 9*hi[8]*K[1]/40.0)-(DdZ[8]+3*hi[8]/10.0)));
        K[3] =  hi[8]*(-Kvect.at(15)*((DdZ[1] + 44*hi[8]*K[0]/45.0 + (-56*hi[8]*K[1]/15.0) + 32*hi[8]*K[2]/9.0)-(DdZ[8]+4*hi[8]/5.0)));
        K[4] =  hi[8]*(-Kvect.at(15)*((DdZ[1] + 19372*hi[8]*K[0]/6561.0 + (-25360*hi[8]*K[1]/2187.0) + 64448*hi[8]*K[2]/6561.0 + (-212*hi[8]*K[3]/729.0))-(DdZ[8]+8*hi[8]/9.0)));
        K[5] =  hi[8]*(-Kvect.at(15)*((DdZ[1] + 9017*hi[8]*K[0]/3168.0 + (-355*hi[8]*K[1]/33.0) + 46732*hi[8]*K[2]/5247.0 + (49*hi[8]*K[3]/176.0) + (-5103*hi[8]*K[4]/18656.0))-(DdZ[8]+hi[8])));
        K[6] =  hi[8]*(-Kvect.at(15)*((DdZ[1] + 35*hi[8]*K[0]/384.0 + 500*hi[8]*K[2]/1113.0 + (125*hi[8]*K[3]/192.0) + (-2187*hi[8]*K[4]/6784.0) + 11*hi[8]*K[5]/84.0)-(DdZ[8]+hi[8])));
        ...
        if( ((DdZ[9]/Kvect.at(4))-Kvect.at(1)) == 0){
             Heavi2 = 0.5;}
        K[0] = hi[9]*(-Kvect.at(30)*DdZ[7]+Kvect.at(30)*((DdZ[9]/Kvect.at(4))-Kvect.at(1))*Heavi2);

        if( (((DdZ[9]+ hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) > 0){
             Heavi2 = 1;}
        if( (((DdZ[9]+ hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) < 0){
             Heavi2 = 0;}
        if( (((DdZ[9]+ hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) == 0){
             Heavi2 = 0.5;}
        K[1] = hi[9]*(-Kvect.at(30)*(DdZ[7]+ hi[9]*K[0]/5.0)+Kvect.at(30)*(((DdZ[9]+ hi[9]/5.0)/Kvect.at(4))-Kvect.at(1))*Heavi2);

        if( (((DdZ[9]+ 3*hi[9]/10.0)/Kvect.at(4))-Kvect.at(1)) > 0){
             Heavi2 = 1;}
        if( (((DdZ[9]+ 3*hi[9]/10.0)/Kvect.at(4))-Kvect.at(1)) < 0){
             Heavi2 = 0;}
        if( (((DdZ[9]+ 3*hi[9]/10.0)/Kvect.at(4))-Kvect.at(1)) == 0){
             Heavi2 = 0.5;}
        K[2] = hi[9]*(-Kvect.at(30)*(DdZ[7]+ 3*hi[9]*K[0]/40.0 + 9*hi[9]*K[1]/40.0)+Kvect.at(30)*(((DdZ[9]+ 3*hi[9]/10.0)/Kvect.at(4))-Kvect.at(1))*Heavi2);

        if( (((DdZ[9]+ 4*hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) > 0){
             Heavi2 = 1;}
        if( (((DdZ[9]+ 4*hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) < 0){
             Heavi2 = 0;}
        if( (((DdZ[9]+ 4*hi[9]/5.0)/Kvect.at(4))-Kvect.at(1)) == 0){
             Heavi2 = 0.5;}
        K[3] = hi[9]*(-Kvect.at(30)*(DdZ[7]+ 44*hi[9]*K[0]/45.0 + (-56*hi[9]*K[1]/15.0) + 32*hi[9]*K[2]/9.0)+Kvect.at(30)*(((DdZ[9]+ 4*hi[9]/5.0)/Kvect.at(4))-Kvect.at(1))*Heavi2);

        if( (((DdZ[9]+ 8*hi[9]/9.0)/Kvect.at(4))-Kvect.at(1)) > 0){
             Heavi2 = 1;}
        if( (((DdZ[9]+ 8*hi[9]/9.0)/Kvect.at(4))-Kvect.at(1)) < 0){
             Heavi2 = 0;}
        if( (((DdZ[9]+ 8*hi[9]/9.0)/Kvect.at(4))-Kvect.at(1)) == 0){
             Heavi2 = 0.5;}
        K[4] = hi[9]*(-Kvect.at(30)*(DdZ[7]+ 19372*hi[9]*K[0]/6561.0 + (-25360*hi[9]*K[1]/2187.0) + 64448*hi[9]*K[2]/6561.0 + (-212*hi[9]*K[3]/729.0) )+Kvect.at(30)*(((DdZ[9]+ 8*hi[9]/9.0)/Kvect.at(4))-Kvect.at(1))*Heavi2);

        if( (((DdZ[9]+ hi[9])/Kvect.at(4))-Kvect.at(1)) > 0){
             Heavi2 = 1;}
        if( (((DdZ[9]+ hi[9])/Kvect.at(4))-Kvect.at(1)) < 0){
             Heavi2 = 0;}
        if( (((DdZ[9]+ hi[9])/Kvect.at(4))-Kvect.at(1)) == 0){
             Heavi2 = 0.5;}
        K[5] = hi[9]*(-Kvect.at(30)*(DdZ[7]+ 9017*hi[9]*K[0]/3168.0 + (-355*hi[9]*K[1]/33.0) + 46732*hi[9]*K[2]/5247.0 + (49*hi[9]*K[3]/176.0) + (-5103*hi[9]*K[4]/18656.0) )+Kvect.at(30)*(((DdZ[9]+ hi[9])/Kvect.at(4))-Kvect.at(1))*Heavi2);
        ...
        if( (((DdZ[9]+ hi[9])/Kvect.at(4))-Kvect.at(1)) == 0){
             Heavi2 = 0.5;}
        K[6] = hi[9]*(-Kvect.at(30)*(DdZ[7]+ 35*hi[9]*K[0]/384.0 + 500*hi[9]*K[2]/1113.0 + (125*hi[9]*K[3]/192.0) + (-2187*hi[9]*K[4]/6784.0) + 11*hi[9]*K[5]/84.0)+Kvect.at(30)*(((DdZ[9]+ hi[9])/Kvect.at(4))-Kvect.at(1))*Heavi2);
        ...
        dYt   = DdZ[12] + (35*K[0]/384.0 + 500*K[2]/1113.0 + 125*K[3]/192.0 - 2187*K[4]/6784.0 + 11*K[5]/84.0);
        ...
        K[0] = hi[12]*(-Kvect.at(8)*DdZ[13]+vbas+vbol);
        K[1] = hi[12]*(-Kvect.at(8)*(DdZ[13]+ hi[12]*K[0]/5.0)+vbas+vbol);
        K[2] = hi[12]*(-Kvect.at(8)*(DdZ[13]+ 3*hi[12]*K[0]/40.0 + 9*hi[12]*K[1]/40.0)+(vbas)+vbol);
        K[3] = hi[12]*(-Kvect.at(8)*(DdZ[13]+ 44*hi[12]*K[0]/45.0 + (-56*hi[12]*K[1]/15.0) + 32*hi[12]*K[2]/9.0)+(vbas)+vbol);
        K[4] = hi[12]*(-Kvect.at(8)*(DdZ[13]+ 19372*hi[12]*K[0]/6561.0 + (-25360*hi[12]*K[1]/2187.0) + 64448*hi[12]*K[2]/6561.0 + (-212*hi[12]*K[3]/729.0))+(vbas)+(vbol));
        K[5] = hi[12]*(-Kvect.at(8)*(DdZ[13]+ 9017*hi[12]*K[0]/3168.0 + (-355*hi[12]*K[1]/33.0) + 46732*hi[12]*K[2]/5247.0 + (49*hi[12]*K[3]/176.0) + (-5103*hi[12]*K[4]/18656.0))+(vbas)+(vbol));
        K[6] = hi[12]*(-Kvect.at(8)*(DdZ[13]+ 35*hi[12]*K[0]/384.0 + 500*hi[12]*K[2]/1113.0 + (125*hi[12]*K[3]/192.0) + (-2187*hi[12]*K[4]/6784.0) + 11*hi[12]*K[5]/84.0)+(vbas)+(vbol));
        ...
        K[0] = hi[13]*(Kvect.at(8)*DdZ[13]-Kvect.at(10)*DdZ[10]);
        K[1] = hi[13]*(Kvect.at(8)*(DdZ[13]+ hi[13]/5.0)-Kvect.at(10)*(DdZ[10]+ hi[13]*K[0]/5.0));
        K[2] = hi[13]*(Kvect.at(8)*(DdZ[13]+ 3*hi[13]/10.0)-Kvect.at(10)*(DdZ[10]+ 3*hi[13]*K[0]/40.0 + 9*hi[13]*K[1]/40.0));
        K[3] = hi[13]*(Kvect.at(8)*(DdZ[13]+ 4*hi[13]/5.0)-Kvect.at(10)*(DdZ[10]+ 44*hi[13]*K[0]/45.0 + (-56*hi[13]*K[1]/15.0) + 32*hi[13]*K[2]/9.0));
        K[4] = hi[13]*(Kvect.at(8)*(DdZ[13]+ 8*hi[13]/9.0)-Kvect.at(10)*(DdZ[10]+ 19372*hi[13]*K[0]/6561.0 + (-25360*hi[13]*K[1]/2187.0) + 64448*hi[13]*K[2]/6561.0 + (-212*hi[13]*K[3]/729.0)));
        K[5] = hi[13]*(Kvect.at(8)*(DdZ[13]+ hi[13])-Kvect.at(10)*(DdZ[10]+ 9017*hi[13]*K[0]/3168.0 + (-355*hi[13]*K[1]/33.0) + 46732*hi[13]*K[2]/5247.0 + (49*hi[13]*K[3]/176.0) + (-5103*hi[13]*K[4]/18656.0)));
        K[6] = hi[13]*(Kvect.at(8)*(DdZ[13]+ hi[13])-Kvect.at(10)*(DdZ[10]+ 35*hi[13]*K[0]/384.0 + 500*hi[13]*K[2]/1113.0 + (125*hi[13]*K[3]/192.0) + (-2187*hi[13]*K[4]/6784.0) + 11*hi[13]*K[5]/84.0));

        dIt   = DdZ[10] + (35*K[0]/384.0 + 500*K[2]/1113.0 + 125*K[3]/192.0 - 2187*K[4]/6784.0 + 11*K[5]/84.0);
...
void MainWindow::RungeKutta(int *i)
{
    ...
    double Dbol1=del*OB;
    double Dbol2=(1-del)*OB;
    double Dbol3=0.001; // ??на 0 делить
